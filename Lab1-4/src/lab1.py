...
def normal_distribution():
    for size in sizes:
        ...
        plt.grid()
        plt.show()
        fig.savefig('D:/Учеба/6 семестр/MatemStat/Lab1-4/Res/lab1' +'Normal distribution ' + str(size) +".png")
...
def cauchy_distribution():
    for size in sizes:
        ...
        plt.grid()
        plt.show()
        fig.savefig('D:/Учеба/6 семестр/MatemStat/Lab1-4/Res/lab1' +'Cauchy distribution ' + str(size) +".png")
    return
...
def poisson_distribution():
    for size in sizes:
        ...
        plt.show()
        fig.savefig('D:/Учеба/6 семестр/MatemStat/Lab1-4/Res/lab1' +'Poisson distribution ' + str(size) +".png")
    return
...
def uniform_distribution():
    for size in sizes:
        ...
        plt.grid()
        plt.show()
        fig.savefig('D:/Учеба/6 семестр/MatemStat/Lab1-4/Res/lab1' +'Uniform distribution ' + str(size) +".png")
    return
