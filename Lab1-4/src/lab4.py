...
def DrawGraphics():
    ...
    for num in range(number_of_samples):
        ...
        figures.savefig('D:/Учеба/6 семестр/MatemStat/Lab1-4/Res/lab4' +name_list[num] + str(sizes[size]) + ".png")
    return
...
def DrawKDE():
    ...
    for num in range(number_of_samples):
        for size in range(len(sizes)):
            ...
            plt.show()
            figures.savefig('D:/Учеба/6 семестр/MatemStat/Lab1-4/Res/lab4' + name_list[num] + ' KDE ' + str(sizes[size]) + ".png")
    return
